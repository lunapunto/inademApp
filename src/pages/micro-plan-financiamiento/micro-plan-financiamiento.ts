...
/*
  Generated class for the MicroPlanFinanciamiento page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-micro-plan-financiamiento',
  templateUrl: 'micro-plan-financiamiento.html',
  providers: [AlertController, CookieJS, Storage, ApiCalls, NetworkService]
})
export class MicroPlanFinanciamientoPage {
  ...
  saveReporte(){
    if(this.textSave.length < 200){
      ...
      var col = 'analisis_financiamiento';
