...
/*
  Generated class for the MicroPlanAccion page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-micro-plan-accion',
  templateUrl: 'micro-plan-accion.html',
  providers: [AlertController, CookieJS, Storage, ApiCalls, NetworkService, LoadingController]
})
export class MicroPlanAccionPage {
